                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Ativo</td>
                                            <td>
                                                <a href="product_detail.jsp">22236</a>
                                            </td>
                                        ...
                                        <tr>
                                            <td>Ativo</td>
                                            <td>
                                                <a href="product_detail.jsp">22237</a>
                                            </td>
                                            <td>Casual, Unissex</td>
                                            <td>Camiseta</td>
                                            <td>P</td>
                                        ...
                                        <tr>
                                            <td>Ativo</td>
                                            <td>
                                                <a href="product_detail.jsp">22238</a>
                                            </td>
                                            <td>Casual, Unissex</td>
                                            <td>Camiseta</td>
                                            <td>P</td>
                                        ...
                                        <tr>
                                            <td>Inativo</td>
                                            <td>
                                                <a href="product_detail.jsp">22239</a>
                                            </td>
                                            <td>Casual, Unissex</td>
                                            <td>Camiseta</td>
                                            <td>P</td>
                                        ...
                                        <tr>
                                            <td>Inativo</td>
                                            <td>
                                                <a href="product_detail.jsp">22240</a>
                                            </td>
                                            <td>Casual, Unissex</td>
                                            <td>Camiseta</td>
                                            <td>P</td>
