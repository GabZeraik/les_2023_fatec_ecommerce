						  ...
						  <c:when test="${cursos.dados.size() > 0}">
							<c:forEach items="${cursos.dados}" var="item">
								<tr class="products-row">
							        ...
							        <td class="product-cell data_cadastro_curso"><fmt:formatDate pattern = "dd-MM-yyyy" value = "${item.dta_cadastro.getTime()}"/></td>
								        	...
								        	<div class="details-modal">
					            				...
					            				<div class="details-modal-title">
										            ...
										            <form id="formulario_${item.id}" action="AlterarCurso" method="post" class="login-form">
										            	...
										            	<label for="periodo_Curso" >Período*</label>
							...
							<c:otherwise>
					     		<p>Não há cursos cadastrados ou o parâmetro utilizado não retornou nenhum resultado !</p>
					  		</c:otherwise>
				  		</c:choose>
				  </c:when>
				  <c:otherwise>
